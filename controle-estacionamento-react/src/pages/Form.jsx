    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="text" name="apartamento" value={veiculo.apartamento} onChange={handleInputChange} />
                ...
                <input type="text" name="vaga" value={veiculo.vaga} onChange={handleInputChange} />
